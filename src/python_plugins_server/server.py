...
from src.paddle_api_impl import plugins_pb2_grpc as grpc_servicer, plugins_pb2 as plugins_api
from src.python_plugins_server.container import PaddleProjectContainer, PyPackageInfo, PyModuleInfo
...
class PaddlePythonPluginsServiceImpl(grpc_servicer.PaddlePythonPluginsServicer):
    """
...
async def serve(*, working_dir: str, server_port: int, client_port: int) -> None:
    ...
    grpc_servicer.add_PaddlePythonPluginsServicer_to_server(service, aio_server)
